...
KP.Balance = {
  ...
  abilityUnlocks:[
    ...
    {id:'finalResolve', name:'Финальная решимость', desc:'урон по боссам выше'}
  ],
  ammoTypes:{
  ...
  enemies:{
    zombie:{ hp:82, speed:.075, dmg:11, hitTime:7, xp:16, money:[5,10], detect:360, attackRange:38, shoot:false, jump:true, weight:1, role:'melee', patrol:'floor' },
    runner:{ hp:68, speed:.12, dmg:9, hitTime:6, xp:18, money:[5,11], detect:405, attackRange:34, shoot:false, jump:true, weight:.9, role:'melee', patrol:'floor' },
    ...
    horse:{ hp:160, speed:.22, dmg:18, hitTime:13, xp:48, money:[16,32], detect:560, attackRange:44, shoot:false, jump:true, weight:1.8, role:'charger', patrol:'floor' },
